...
<important_rules>
  ...
  3. **Error Reporting**: If a test fails, provide a concise summary containing:
  ...
  4. **Handoff**: After summarizing the errors, signal that the coding agent should take over to implement the fixes.
